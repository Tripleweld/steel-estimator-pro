    ...
    <div className="border border-steel-700 rounded-lg bg-steel-900/40 overflow-hidden">
      ...
      {open && (
        <div className="p-3 space-y-3">
          {/* ─── BLOCK 0: Visual Diagram ─── */}
          <div className="border border-steel-700 rounded p-3 bg-steel-900/40 flex items-center justify-center">
            <RailingDiagram row={row} calc={calc} />
          </div>
